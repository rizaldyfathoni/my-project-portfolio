...
function Hero() {
  return (
    <section id="hero" className="pb-28 md:pb-44 pt-24 sm:pt-28 md:pt-32 flex px-6 lg:px-24">
      <div className="self-center">
        ...
        <div className="flex gap-2 align-center flex-wrap md:flex-nowrap">
          <div className="lg:w-[80%] text-zinc-900 dark:text-zinc-100 self-center">
            ...
            <p className="mt-6 dark:text-zinc-300 text-base lg:w-[87%] leading-7 font-bold">
              Creating impactful web experiences with precision and performance.
            </p>

            <div className="flex gap-2 mt-6">
              <a
                href="#projects"
                className="px-6 py-3 rounded-lg border border-black hover:bg-red-800 hover:text-white hover:border-red-800 dark:border-white font-medium transition-all duration-300"
              >
                Portfolio
              </a>
              <a

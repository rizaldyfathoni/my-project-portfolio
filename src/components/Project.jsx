...
function Project({ title, description, technologies, link, img }) {
  return (
    <div className="hover:bg-zinc-100 hover:dark:bg-zinc-900 transition-all duration-300 p-6 md:rounded-xl relative">
      ...
      {/* =========== PROJECT TITLE =========== */}
        ...
        </p>
        {
          link !== '' ?
          <>
            <div className="flex justify-center items-center gap-6 text-zinc-600 dark:text-zinc-300 font-medium">
              <a href={link} target="_blank" className="flex gap-2 mt-4 hover:text-red-800 hover:dark:text-red-500 cursor-pointer transition-all duration-300" rel="noreferrer">
